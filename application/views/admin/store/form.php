          ...
          <section class="widget shadow-01 mb-4" id="widget-08">
            <div class="widget-block">
                <?php
                 if($type == "insert"){
                ?>
                    <form action="<?=site_url('store/insert')?>" method="POST">
                <?php
                 }else if($type == "edit"){
                ?>
                    <form action="<?=site_url('store/update/'.$record->id)?>" method="POST">
                <?php
                 }
                 ?>
                    <header>
                    ...
                    <div class="widget-content py-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Masukkan Nama Toko" name="name" value="<?= $type=='edit'?$record->name:''?>">
                        </div>
                        <div class="form-group">
